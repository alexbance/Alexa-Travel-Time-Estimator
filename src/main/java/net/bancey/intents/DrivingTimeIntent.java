        ...
        if (matrix != null) {
            for (DistanceMatrixRow row : matrix.rows) {
                for(DistanceMatrixElement element: row.elements) {
                    ...
                    System.out.println(eta);
                    cardText = "There is " + element.distance + " between " + origin + " and " + destination + ". It will take you approximately " + element.durationInTraffic + " to reach " + destination + ". Your ETA is " + eta.hourOfDay().getAsText() + ":" + eta.minuteOfHour().getAsText();
                    speechText = "<speak>There is " + element.distance + " between " + origin + " and " + destination + ". It will take you approximately " + element.durationInTraffic + " to reach " + destination + ". Your ETA is <say-as interpret-as=\"time\">" + eta.hourOfDay().getAsText() + ":" + eta.minuteOfHour().getAsText() + "</say-as></speak>";
