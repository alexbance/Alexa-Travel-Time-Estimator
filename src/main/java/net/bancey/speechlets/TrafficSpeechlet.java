...
public class TrafficSpeechlet implements Speechlet {
    ...
    private SpeechletResponse onHelpResponse() {
        String speechText = "<speak><s>Welcome!</s> <s>This skill allows you to get an ETA to travel from point A to point B.</s> <s>For Example: 'ask traffic for driving e. t. a. from Bisley to Woking Surrey'.</s> <s>You can substitute driving for walking or cycling,<break strength=\"medium\" /> if you don't specify<break strength=\"medium\" /> or the specified value is invalid<break strength=\"medium\" /> driving will be used.</s> <s>Note this skill only works with GB locations.</s></speak>";
